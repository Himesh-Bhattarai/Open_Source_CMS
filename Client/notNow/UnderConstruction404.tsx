...
export default function FeatureUnderConstruction() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-white dark:from-gray-900 dark:to-gray-950 flex items-center justify-center p-4">
      {/* Background Elements */}
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute inset-0">
          {[...Array(12)].map((_, i) => (
            <motion.div
              key={i}
              className="absolute h-0.5 bg-linear-to-br from-transparent via-gray-300 dark:via-gray-700 to-transparent"
      ...
      >
        ...
        <Card className="border-2 border-dashed border-gray-300 dark:border-gray-700 shadow-2xl backdrop-blur-sm bg-white/90 dark:bg-gray-900/90">
          <CardContent className="p-8">
            ...
            <div className="text-center mb-8">
              <div className="relative inline-block">
                <motion.div
                  ...
                  className="text-9xl font-black tracking-tighter bg-linear-to-br from-gray-900 to-gray-700 dark:from-gray-100 dark:to-gray-300 bg-clip-text text-transparent"
                >
                  404
                </motion.div>
                <motion.div
            ...
            >
              ...
              <div className="bg-linear-to-br from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-lg p-4 border border-blue-200 dark:border-blue-800">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-900 dark:text-gray-100">
                      Coming Soon in{" "}
                      <span className="bg-linear-to-br from-purple-600 to-blue-600 bg-clip-text text-transparent font-bold">
                        v2.0
                      </span>
                    </p>
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <div className="h-2 bg-gray-200 dark:bg-gray-800 rounded-full overflow-hidden">
                  <motion.div
                    className="h-full bg-linear-to-br from-blue-500 to-purple-500"
                    initial={{ width: "0%" }}
                    animate={{ width: "65%" }}
        ...
        >
          <div className="w-12 h-12 bg-linear-to-br from-purple-500 to-pink-500 rounded-lg rotate-12 shadow-lg flex items-center justify-center">
        ...
        >
          <div className="w-10 h-10 bg-linear-to-br from-blue-500 to-cyan-500 rounded-full shadow-lg flex items-center justify-center">
