          ...
          <div className="space-y-4">
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  handleBlockUpdate(block.id, "title", e.target.value)
                }
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  handleBlockUpdate(block.id, "subtitle", e.target.value)
                }
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  handleBlockUpdate(block.id, "buttonText", e.target.value)
                }
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  handleBlockUpdate(block.id, "buttonLink", e.target.value)
                }
                placeholder="/contact"
              />
            </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  handleBlockUpdate(block.id, "heading", e.target.value)
                }
            ...
            <div>
              ...
              <Textarea
                ...
                onChange={(e) =>
                  handleBlockUpdate(block.id, "content", e.target.value)
                }
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Feature list editor would go here
              </p>
            </div>
          </div>
        );
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Textarea
                ...
                onChange={(e) =>
                  handleBlockUpdate(block.id, "description", e.target.value)
                }
    ...
    switch (block.type) {
        ...
        return (
          <div className="bg-linear-to-br from-primary/10 to-primary/5 p-12 rounded-lg text-center">
            <h1 className="text-4xl font-bold mb-4">
              {block.data.title || "Hero Headline"}
            </h1>
            <p className="text-xl text-muted-foreground mb-6">
              {block.data.subtitle || "Hero subtitle text"}
            </p>
      ...
      case "text":
        return (
          <div className="p-8">
            {block.data.heading && (
              <h2 className="text-2xl font-bold mb-4">{block.data.heading}</h2>
            )}
            <p className="text-muted-foreground leading-relaxed">
              {block.data.content || "Text content goes here..."}
            </p>
          </div>
        );
        ...
        return (
          <div className="bg-primary text-primary-foreground p-12 rounded-lg text-center">
            ...
            <p className="text-lg mb-6 opacity-90">
              {block.data.description || "Compelling description text"}
            </p>
