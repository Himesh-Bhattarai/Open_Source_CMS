        ...
        <div className="prose prose-gray dark:prose-invert max-w-none space-y-8">
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              By accessing and using ContentFlow, you accept and agree to be bound by the terms and provision of this
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              Permission is granted to use ContentFlow for commercial and personal purposes under the following
              conditions:
            </p>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              to do so constitutes a breach of the Terms. You are responsible for safeguarding the password and for all
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              Our service allows you to create, upload, and manage content. You retain ownership of any intellectual
              property rights that you hold in that content. By uploading content, you grant us a license to use,
              modify, and display that content for the purpose of operating and providing the service.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              You are responsible for the content you create and must ensure it does not violate any laws or infringe on
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">You may not use ContentFlow:</p>
            <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              and periodic basis. Billing cycles are set on a monthly or annual basis, depending on the type of
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              In no event shall ContentFlow, nor its directors, employees, partners, agents, suppliers, or affiliates,
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mt-2">Email: legal@contentflow.com</p>
          </section>
        </div>
      </div>
    </div>
