        ...
        <div className="prose prose-gray dark:prose-invert max-w-none space-y-8">
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Welcome to ContentFlow. We respect your privacy and are committed to protecting your personal data. This
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mt-2">Email: privacy@contentflow.com</p>
          </section>
        </div>
      </div>
    </div>
