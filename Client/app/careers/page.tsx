...
const openRoles = [
  {
    ...
    team: "CMS Experience",
    summary:
      "Build editor workflows, live previews, and consistent UI systems across the dashboard.",
  },
  {
    ...
    team: "Platform APIs",
    summary:
      "Design secure APIs, tenant isolation logic, and scalable data models for CMS modules.",
  },
  {
    ...
    team: "Design Systems",
    summary:
      "Create clear content management experiences and reusable, production-ready interface patterns.",
  },
];
      ...
      <div className="container mx-auto px-4 py-10 space-y-8">
          ...
          <CardContent className="grid gap-3 md:grid-cols-3 text-sm">
            <div className="rounded-md border p-3">
              <p className="font-medium flex items-center gap-2">
                <Wrench className="h-4 w-4" /> Production Focus
              </p>
              <p className="text-muted-foreground mt-1">
                We ship secure, maintainable features, not demos.
              </p>
            </div>
            <div className="rounded-md border p-3">
              <p className="font-medium flex items-center gap-2">
                <Users className="h-4 w-4" /> Small, Senior Team
              </p>
              <p className="text-muted-foreground mt-1">
                You collaborate directly on product and system decisions.
              </p>
            </div>
            <div className="rounded-md border p-3">
              <p className="font-medium flex items-center gap-2">
                <CheckCircle2 className="h-4 w-4" /> Real Ownership
              </p>
              <p className="text-muted-foreground mt-1">
                You own modules end-to-end, from design to operations.
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Simple and technical: we evaluate practical capability.
            </CardDescription>
          </CardHeader>
